...
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Address__Modifie__276EDEB3] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Address] ADD CONSTRAINT [PK__Address__091C2A1B20268E7D] PRIMARY KEY CLUSTERED  ([AddressID]) ON [PRIMARY]
GO
